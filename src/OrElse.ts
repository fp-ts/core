 ...
 * @since 3.0.0
 */
export const firstSuccessOf = <F extends TypeLambda>(OrElse: OrElse<F>) =>
  <S, R1, O1, E1, A>(head: Kind<F, S, R1, O1, E1, A>) =>
    <R2, O2, E2, B>(
      tail: Iterable<Kind<F, S, R2, O2, E2, B>>
    ): Kind<F, S, R1 & R2, O1 | O2, E1 | E2, A | B> => OrElse.firstSuccessOf(head, tail)
