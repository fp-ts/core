 ...
 * @since 3.0.0
 */
export const fromAsync: <A>(ma: Async<A>) => ReaderAsyncResult<unknown, never, A> =flow(
 ...
 * @since 3.0.0
 */
export const failAsync: <E>(me: Async<E>) => ReaderAsyncResult<unknown, E, never> =flow(
...
export const getOrElseReaderAsync: <R2, B>(
 ...
 resultT.getOrElseKind(readerAsync.Monad)
...
export const toUnion: <R, E, A>(fa: ReaderAsyncResult<R, E, A>) => ReaderAsync<R, E | A> =
 resultT.toUnion(readerAsync.Functor)
...
export const catchAll: <E1, R2, E2, B>(
 ...
 resultT.catchAll(readerAsync.Monad)
...
export const tapError: <E1, R2, E2>(
 ...
 resultT.tapLeft(readerAsync.Monad)
