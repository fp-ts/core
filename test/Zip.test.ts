...
describe("Zip", () => {
  ...
  it("zipComposition", () => {
    ...
    ) => O.Option<O.Option<readonly [A, B]>> = _.zipComposition(Zip, Zip)
  ...
  it("lift2", () => {
    const sum = _.lift2(Zip)((a: number, b: number) => a + b)
  ...
  it("lift3", () => {
    const sum = _.lift3(Zip)((a: number, b: number, c: number) => a + b + c)
