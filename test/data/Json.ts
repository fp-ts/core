...
import * as _ from "@fp-ts/core/data/Json"
...
describe("Json", () => {
  it("parse", () => {
    ...
    U.deepStrictEqual(
      pipe("{\"a\":}", _.parse),
      E.fail(new SyntaxError("Unexpected token } in JSON at position 5"))
    )
  })
  ...
  it("stringify", () => {
    ...
    U.deepStrictEqual(
      ...
      E.fail(new Error("Converting unsupported structure to JSON"))
    )
  })
})
