...
```ts
export declare const fromOption: <E>(onNone: E) => <A>(fa: any) => Result<E, A>
```
...
```ts
export declare const getFailure: <E, A>(self: Result<E, A>) => any
```
...
```ts
export declare const getSuccess: <E, A>(self: Result<E, A>) => any
```
...
```ts
export declare const compact: <E>(onNone: E) => <A>(self: Result<E, any>) => Result<E, A>
```
...
export declare const filter: {
  <C extends A, B extends A, E2, A = C>(refinement: any, onFalse: E2): <E1>(self: Result<E1, C>) => Result<E2 | E1, B>
  <B extends A, E2, A = B>(predicate: any, onFalse: E2): <E1>(self: Result<E1, B>) => Result<E2 | E1, B>
}
```
...
```ts
export declare const filterMap: <A, B, E>(f: (a: A) => any, onNone: E) => (self: Result<E, A>) => Result<E, B>
```
...
export declare const partition: {
  ...
  <B extends A, E, A = B>(predicate: any, onFalse: E): (self: Result<E, B>) => readonly [Result<E, B>, Result<E, B>]
}
```
...
export declare const traverseFilterMap: <F extends any>(
  Applicative: any
) => <A, S, R, O, FE, B, E>(f: (a: A) => any, onNone: E) => (self: Result<E, A>) => any
```
...
export declare const traversePartitionMap: <F extends any>(
  Applicative: any
) => <A, S, R, O, FE, B, C, E>(f: (a: A) => any, onNone: E) => (self: Result<E, A>) => any
```
...
```ts
export declare const foldMap: <M>(Monoid: any) => <A>(f: (a: A) => M) => <E>(self: Result<E, A>) => M
```
...
```ts
export declare const getTraversableFilterable: <E>(onEmpty: E) => any
```
...
export declare const liftPredicate: {
  <C extends A, B extends A, E, A = C>(refinement: any, onFalse: E): (c: C) => Result<E, B>
  <B extends A, E, A = B>(predicate: any, onFalse: E): (b: B) => Result<E, B>
}
```
...
```ts
export declare const sequence: <F extends any>(F: any) => <E, FS, FR, FO, FE, A>(fa: Result<E, any>) => any
```
...
export declare const traverse: <F extends any>(
  F: any
) => <A, FS, FR, FO, FE, B>(f: (a: A) => any) => <E>(ta: Result<E, A>) => any
```
...
```ts
export declare const traverseNonEmptyReadonlyArray: <A, E, B>(f: (a: A) => Result<E, B>) => (as: any) => Result<E, any>
```
...
```ts
export declare const elem: <A>(E: any) => (a: A) => <E>(ma: Result<E, A>) => boolean
```
...
```ts
export declare const exists: <A>(predicate: any) => (ma: Result<unknown, A>) => boolean
```
