...
```ts
export declare const fromAsync: <A>(fa: any) => ReaderAsync<unknown, A>
```
...
```ts
export declare const fromReader: <R, A>(fa: any) => ReaderAsync<R, A>
```
...
```ts
export declare const fromReaderSync: <R, A>(fa: any) => ReaderAsync<R, A>
```
...
```ts
export declare const fromSync: <A>(fa: any) => ReaderAsync<unknown, A>
```
...
```ts
export declare const flatMapAsync: <A, B>(f: (a: A) => any) => <R>(self: ReaderAsync<R, A>) => ReaderAsync<R, B>
```
...
```ts
export declare const flatMapSync: <A, B>(f: (a: A) => any) => <R>(self: ReaderAsync<R, A>) => ReaderAsync<R, B>
```
