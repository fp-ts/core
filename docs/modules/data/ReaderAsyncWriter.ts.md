---
title: data/ReaderAsyncWriter.ts
nav_order: 30
parent: Modules
---
...
```ts
export declare const fromAsync: <W>(w: W) => <A>(fa: any) => ReaderAsyncWriter<unknown, W, A>
```
...
```ts
export declare const fromAsyncWriter: <W, A>(a: any) => ReaderAsyncWriter<unknown, W, A>
```
...
```ts
export declare const fromReader: <W>(w: W) => <R, A>(fa: any) => ReaderAsyncWriter<R, W, A>
```
...
```ts
export declare const fromReaderAsync: <W>(w: W) => <R, A>(a: any) => ReaderAsyncWriter<R, W, A>
```
...
```ts
export declare const fromReaderWriter: <R, W, A>(fa: any) => ReaderAsyncWriter<R, W, A>
```
...
```ts
export declare const fromSync: <W>(w: W) => <A>(fa: any) => ReaderAsyncWriter<unknown, W, A>
```
...
```ts
export declare const fromWriter: <W, A>(fa: any) => ReaderAsyncWriter<unknown, W, A>
```
...
```ts
export declare const getApplicative: <W>(Apply: any, Monoid: any) => any
```
...
```ts
export declare const getApply: <W>(Apply: any, Semigroup: any) => any
```
...
```ts
export declare const getFromAsync: <W>(M: any) => any
```
...
```ts
export declare const getFromReader: <W>(M: any) => any
```
...
```ts
export declare const getFromSync: <W>(M: any) => any
```
...
export declare const traverseNonEmptyReadonlyArray: <W>(
  Apply: any,
  Semigroup: any
) => <A, R, B>(f: (a: A) => ReaderAsyncWriter<R, W, B>) => (as: any) => ReaderAsyncWriter<R, W, any>
```
...
export declare const traverseNonEmptyReadonlyArrayWithIndex: <W>(
  Apply: any,
  Semigroup: any
) => <A, R, B>(f: (index: number, a: A) => ReaderAsyncWriter<R, W, B>) => (as: any) => ReaderAsyncWriter<R, W, any>
```
...
```ts
export declare const fst: <R, W, A>(self: ReaderAsyncWriter<R, W, A>) => any
```
...
```ts
export declare const snd: <R, W, A>(self: ReaderAsyncWriter<R, W, A>) => any
```
