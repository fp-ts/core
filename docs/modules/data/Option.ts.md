...
```ts
export declare const fromResult: <E, A>(self: any) => Option<A>
```
...
```ts
export declare const toResult: <E>(onNone: E) => <A>(self: Option<A>) => any
```
...
export declare const partition: {
  <C extends A, B extends A, A = C>(refinement: any): (fc: Option<C>) => readonly [Option<C>, Option<B>]
  <B extends A, A = B>(predicate: any): (fb: Option<B>) => readonly [Option<B>, Option<B>]
}
```
...
```ts
export declare const partitionMap: <A, B, C>(f: (a: A) => any) => (fa: Option<A>) => readonly [Option<B>, Option<C>]
```
...
```ts
export declare const separate: <A, B>(fe: Option<any>) => readonly [Option<A>, Option<B>]
```
...
export declare const traverseFilter: <F extends any>(
  F: any
) => <B extends A, S, R, O, E, A = B>(predicate: (a: A) => any) => (self: Option<B>) => any
```
...
export declare const traverseFilterMap: <F extends any>(
  F: any
) => <A, S, R, O, E, B>(f: (a: A) => any) => (ta: Option<A>) => any
```
...
export declare const traversePartitionMap: <F extends any>(
  F: any
) => <A, S, R, O, E, B, C>(f: (a: A) => any) => (wa: Option<A>) => any
```
...
```ts
export declare const foldMap: <M>(Monoid: any) => <A>(f: (a: A) => M) => (self: Option<A>) => M
```
...
```ts
export declare const liftResult: <A extends readonly unknown[], E, B>(f: (...a: A) => any) => (...a: A) => Option<B>
```
...
```ts
export declare const match: <B, A, C = B>(onNone: any, onSome: (a: A) => C) => (ma: Option<A>) => B | C
```
...
```ts
export declare const flatMapResult: <A, E, B>(f: (a: A) => any) => (ma: Option<A>) => Option<B>
```
...
```ts
export declare const sequence: <F extends any>(F: any) => <S, R, O, E, A>(fas: Option<any>) => any
```
...
```ts
export declare const traverse: <F extends any>(F: any) => <A, S, R, O, E, B>(f: (a: A) => any) => (ta: Option<A>) => any
```
...
```ts
export declare const traverseNonEmptyReadonlyArray: <A, B>(f: (a: A) => Option<B>) => (as: any) => Option<any>
```
...
```ts
export declare const elem: <A>(E: any) => (a: A) => (ma: Option<A>) => boolean
```
...
```ts
export declare const exists: <A>(predicate: any) => (ma: Option<A>) => boolean
```
