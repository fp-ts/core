...
```ts
export declare const failSync: <E>(me: any) => SyncResult<E, never>
```
...
```ts
export declare const fromOption: <E>(onNone: E) => <A>(fa: any) => SyncResult<E, A>
```
...
```ts
export declare const fromResult: <E, A>(fa: any) => SyncResult<E, A>
```
...
```ts
export declare const fromSync: <A>(ma: any) => SyncResult<never, A>
```
...
```ts
export declare const flatMapError: <E1, E2>(f: (e: E1) => any) => <A>(self: SyncResult<E1, A>) => SyncResult<E2, A>
```
...
```ts
export declare const getOrElse: <B>(onError: B) => <A>(self: SyncResult<unknown, A>) => any
```
...
```ts
export declare const getOrElseSync: <B>(onError: any) => <A>(self: SyncResult<unknown, A>) => any
```
...
```ts
export declare const compact: <E>(onNone: E) => <A>(self: SyncResult<E, any>) => SyncResult<E, A>
```
...
export declare const filter: {
  ...
  <B extends A, E2, A = B>(predicate: any, onFalse: E2): <E1>(mb: SyncResult<E1, B>) => SyncResult<E2 | E1, B>
}
```
...
```ts
export declare const filterMap: <A, B, E>(f: (a: A) => any, onNone: E) => (self: SyncResult<E, A>) => SyncResult<E, B>
```
...
export declare const separate: <E>(
  onEmpty: E
) => <A, B>(self: SyncResult<E, any>) => readonly [SyncResult<E, A>, SyncResult<E, B>]
```
...
```ts
export declare const toUnion: <E, A>(fa: SyncResult<E, A>) => any
```
...
export declare const liftPredicate: {
  <C extends A, B extends A, E, A = C>(refinement: any, onFalse: E): (c: C) => SyncResult<E, B>
  <B extends A, E, A = B>(predicate: any, onFalse: E): (b: B) => SyncResult<E, B>
}
```
...
```ts
export declare const flatMapSync: <A, B>(f: (a: A) => any) => <E>(self: SyncResult<E, A>) => SyncResult<E, B>
```
...
export declare const bracket: <E1, A, E2, B, E3>(
  ...
  release: (a: A, e: any) => SyncResult<E3, void>
